...
//};
  ...
  {APIData.map((data) => {
     return (
       ...
       <Table.Row>
          <Table.Cell>{data.taskID}</Table.Cell>
           <Table.Cell>{data.code}</Table.Cell>
           <Table.Cell>{data.paramTaskTypeID}</Table.Cell>
           <Table.Cell>{data.paramTaskPriorityID}</Table.Cell>
           <Table.Cell>{data.taskName}</Table.Cell>
           <Table.Cell>{data.paramTaskStatusID}</Table.Cell>
